...
class CustomMalla extends Malla {
  constructor(t = !1, e = Ramo, a = 1, r = 1) {
    super(t, e, a, r),
      (this.customSectors = void 0),
      (this.customSubjects = void 0),
      (this.customMalla = void 0);
  }
  setCareer(t, e, a) {
    let r = localStorage["generatorUserCategory" + t],
      s = localStorage["generatorUserSubjects" + t],
      i = localStorage["generatorUserData" + t];
    return (
      void 0 !== s && (this.customSubjects = JSON.parse(s)),
      void 0 !== r && (this.customSectors = JSON.parse(r)),
      void 0 !== i && (this.customMalla = JSON.parse(i)),
      super.setCareer(t, e, a)
    );
  }
  setMallaAndCategories(t, e) {
    if (void 0 === this.customMalla)
      return void super.setMallaAndCategories(t, e);
    let a,
      r = 0,
      s = 0,
      i = 0,
      l = new Set(),
      n = new Set();
    Object.values(this.customMalla).forEach((t) => {
      (l = new Set([...l, ...t])),
      ...
      (this.longestSemester = r),
      (this.totalSubjects = i),
      Object.keys(this.customMalla).forEach((e) => {
        (this.malla[e] = {}),
          this.customMalla[e].forEach((a) => {
            if (
              (Object.keys(t).forEach((r) => {
                let s = 0;
                for (; s < t[r].length; s++)
                  if (t[r][s][1] === a && void 0 === this.customSubjects[a]) {
                    let i = t[r][s];
                    if (7 === i.length) {
                      let t = [...i[5]];
                      n.add(i[4]),
                        t.forEach((t) => {
                          l.has(t) || i[5].splice(i[5].indexOf(t), 1);
                        }),
                        (this.malla[e][a] = new this.subjectType(
                          i[0],
                          i[1],
                          i[2],
                          i[4],
                        ...
                        (this.malla[e][a] = new this.subjectType(
                          ...
                          (function () {
                            if (i.length > 4) {
                              return (
                                [...i[4]].forEach((t) => {
                                  l.has(t) || i[4].splice(i[4].indexOf(t), 1);
                                }),
                                i[4]
                              );
                            }
              ...
              if (void 0 !== this.customSubjects[a]) {
                let t = this.customSubjects[a];
                n.add(t[2]),
                  [...t[3]].forEach((e) => {
                    l.has(e) || t[3].splice(t[3].indexOf(e), 1);
                  }),
                  (this.malla[e][a] = new this.subjectType(
                    t[0],
                    a,
              ...
              (s += this.malla[e][a].getDisplayCredits()),
                this.addSubject(this.malla[e][a]);
            }
          });
      }),
      (this.totalCredits = s),
      (this.categories = {}),
      (a = this.customSectors ? this.customSectors : e),
      (n = [...n]),
      n.forEach((t) => {
        this.categories[t] = a[t];
      }),
      (this.isMallaSet = !0),
